...
function normalizeOptions(host, schema) {
    ...
    const ngCliSchematicLibRoot = newProjectRoot
        ...
        : projectName;
    return Object.assign(Object.assign({}, options), { linter: (_d = options.linter) !== null && _d !== void 0 ? _d : linter_1.Linter.EsLint, unitTestRunner: (_e = options.unitTestRunner) !== null && _e !== void 0 ? _e : "jest" /* UnitTestRunner.Jest */, prefix, name: projectName, projectRoot, entryFile: 'index', moduleName,
        projectDirectory,
        modulePath,
        parsedTags,
        fileName,
