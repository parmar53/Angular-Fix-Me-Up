...
function updateStorybookTarget(projectConfiguration, storybookTarget, projectName, buildTarget, storybookBuildTarget) {
    var _a, _b;
    const oldStorybookTargetConfig = (_a = projectConfiguration === null || projectConfiguration === void 0 ? void 0 : projectConfiguration.targets) === null || _a === void 0 ? void 0 : _a[storybookTarget];
    const newStorybookTargetConfig = {
        executor: '@storybook/angular:start-storybook',
        options: {
            port: oldStorybookTargetConfig.options.port,
            configDir: (_b = oldStorybookTargetConfig.options.config) === null || _b === void 0 ? void 0 : _b.configFolder,
    ...
    const _c = oldStorybookTargetConfig.options, { uiFramework, outputPath, config, projectBuildConfig } = _c, optionsToCopy = tslib_1.__rest(_c, ["uiFramework", "outputPath", "config", "projectBuildConfig"]);
...
function updateStorybookBuildTarget(projectConfiguration, projectName, buildTarget, storybookBuildTarget) {
    var _a, _b;
    const oldStorybookBuildTargetConfig = (_a = projectConfiguration === null || projectConfiguration === void 0 ? void 0 : projectConfiguration.targets) === null || _a === void 0 ? void 0 : _a[storybookBuildTarget];
    const newStorybookBuildTargetConfig = {
        ...
        options: {
            ...
            configDir: (_b = oldStorybookBuildTargetConfig.options.config) === null || _b === void 0 ? void 0 : _b.configFolder,
            browserTarget: undefined,
            compodoc: false,
        },
    ...
    const _c = oldStorybookBuildTargetConfig.options, { uiFramework, outputPath, config, projectBuildConfig } = _c, optionsToCopy = tslib_1.__rest(_c, ["uiFramework", "outputPath", "config", "projectBuildConfig"]);
